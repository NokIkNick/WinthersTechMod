package com.wintherdev.wintherstechmod.item.custom;
...
public class ChiselItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if(CHISEL_MAP.containsKey(clicked)){
            if(!level.isClientSide()){
                level.setBlockAndUpdate(context.getClickedPos(), CHISEL_MAP.get(clicked).defaultBlockState());
